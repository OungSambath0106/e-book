...
@section('contents')
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between pb-0">
                            <h5 class="pb-1">{{ __('Banner Table') }}</h5>
                            @if (auth()->user()->can('banner.create'))
                                <a class="btn bg-gradient-primary btn-modal add-new-button-right-side btn-xs" href="#" data-href="{{ route('admin.banner.create') }}"
    ...
    @include('backends.banner.partial.delete_banner_modal')
@endsection
@push('js')
    <script>
    ...
    <script>
        ...
        //for update status
        initializeStatusInput("{{ route('admin.banner.update_status') }}");
    </script>
@endpush

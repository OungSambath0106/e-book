                ...
                <tr>
                    ...
                    <td class="align-middle text-center">
                        ...
                        @if (auth()->user()->can('banner.delete'))
                            <form action="{{ route('admin.banner.destroy', $banner->id) }}" class="d-inline-block form-delete-{{ $banner->id }}">
                                @csrf
                                @method('DELETE')
                                <button type="button" data-id="{{ $banner->id }}" data-href="{{ route('admin.banner.destroy', $banner->id) }}" class="btn-delete ps-0" title="Delete" style="background: none; border: none;" data-bs-toggle="tooltip" data-bs-placement="top">

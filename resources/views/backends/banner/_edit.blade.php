...
<div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content">
        ...
        <form action="{{ route('admin.banner.update', $baner->id) }}" enctype="multipart/form-data"
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-md-12 px-0">
                    ...
                    <input type="file" id="dropifyInput" class="dropify custom-file-input" name="image"
                            data-default-file="{{ isset($baner) && $baner->image && file_exists(public_path('uploads/banners/' . $baner->image))
                            ? asset('uploads/banners/' . $baner->image)
...
@include('backends.banner.partial.delete_banner_image_modal')
<script>
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-confirm-modal').click(function () {
            if (banerId) {
                $.ajax({
                    url: "{{ route('admin.banner.delete_image') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        baner_id: banerId
